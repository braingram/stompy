...
HIP_CYLINDER_TRAVEL = 7.153837
HIP_MIDDLE_CYLINDER_TRAVEL = 8.0
#HIP_MIDDLE_CYLINDER_ZERO = 20.314961
HIP_MIDDLE_CYLINDER_ZERO = 20.30
#HIP_CYLINDER_ZERO = 19.80315
HIP_CYLINDER_ZERO = 19.8173
HIP_CYLINDER_MAX_LENGTH = HIP_CYLINDER_MIN_LENGTH + HIP_CYLINDER_TRAVEL
HIP_MIDDLE_CYLINDER_MAX_LENGTH = (
    HIP_CYLINDER_MIN_LENGTH + HIP_MIDDLE_CYLINDER_TRAVEL)
...
HIP_MIDDLE_MIN_ANGLE = max(
    ...
    -hip_middle_angle(HIP_MIDDLE_CYLINDER_MAX_LENGTH))
