...
#
# Created: Sat Feb 23 10:27:02 2019
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.configTree.topLevelItem(4).setText(0, _translate("MainWindow", "controller.res.cfg.eps", None))
        self.configTree.topLevelItem(4).setText(1, _translate("MainWindow", "0.9", None))
        self.configTree.topLevelItem(5).setText(0, _translate("MainWindow", "controller.res.cfg.calf_eps", None))
        self.configTree.topLevelItem(5).setText(1, _translate("MainWindow", "0.9", None))
        self.configTree.topLevelItem(6).setText(0, _translate("MainWindow", "controller.res.cfg.max_calf_angle", None))
        self.configTree.topLevelItem(6).setText(1, _translate("MainWindow", "0.5", None))
        self.configTree.topLevelItem(7).setText(0, _translate("MainWindow", "controller.res.cfg.dr_smooth", None))
        self.configTree.topLevelItem(7).setText(1, _translate("MainWindow", "0.5", None))
        self.configTree.topLevelItem(8).setText(0, _translate("MainWindow", "controller.res.cfg.r_max", None))
        self.configTree.topLevelItem(8).setText(1, _translate("MainWindow", "0.9", None))
        self.configTree.topLevelItem(9).setText(0, _translate("MainWindow", "controller.res.cfg.r_thresh", None))
        self.configTree.topLevelItem(9).setText(1, _translate("MainWindow", "0.2", None))
        self.configTree.topLevelItem(10).setText(0, _translate("MainWindow", "controller.res.cfg.loaded_weight", None))
        self.configTree.topLevelItem(10).setText(1, _translate("MainWindow", "300.", None))
        self.configTree.topLevelItem(11).setText(0, _translate("MainWindow", "controller.res.cfg.unloaded_weight", None))
        self.configTree.topLevelItem(11).setText(1, _translate("MainWindow", "600.", None))
        self.configTree.topLevelItem(12).setText(0, _translate("MainWindow", "controller.res.cfg.swing_slop", None))
        self.configTree.topLevelItem(12).setText(1, _translate("MainWindow", "5.", None))
        self.configTree.topLevelItem(13).setText(0, _translate("MainWindow", "controller.res.cfg.lift_height", None))
        self.configTree.topLevelItem(13).setText(1, _translate("MainWindow", "8.0", None))
        self.configTree.topLevelItem(14).setText(0, _translate("MainWindow", "controller.res.cfg.height_slop", None))
        self.configTree.topLevelItem(14).setText(1, _translate("MainWindow", "5.", None))
        self.configTree.topLevelItem(15).setText(0, _translate("MainWindow", "controller.res.cfg.lower_height", None))
        self.configTree.topLevelItem(15).setText(1, _translate("MainWindow", "-50", None))
        self.configTree.topLevelItem(16).setText(0, _translate("MainWindow", "controller.res.cfg.step_ratio", None))
        self.configTree.topLevelItem(16).setText(1, _translate("MainWindow", "0.8", None))
        self.configTree.topLevelItem(17).setText(0, _translate("MainWindow", "controller.res.cfg.target_calf_angle", None))
        self.configTree.topLevelItem(17).setText(1, _translate("MainWindow", "0.0", None))
        self.configTree.topLevelItem(18).setText(0, _translate("MainWindow", "controller.res.cfg.speeds", None))
        self.configTree.topLevelItem(18).child(0).setText(0, _translate("MainWindow", "lift", None))
        self.configTree.topLevelItem(18).child(0).setText(1, _translate("MainWindow", "4.0", None))
        self.configTree.topLevelItem(18).child(1).setText(0, _translate("MainWindow", "lower", None))
        self.configTree.topLevelItem(18).child(1).setText(1, _translate("MainWindow", "3.0", None))
        self.configTree.topLevelItem(18).child(2).setText(0, _translate("MainWindow", "stance", None))
        self.configTree.topLevelItem(18).child(2).setText(1, _translate("MainWindow", "3.0", None))
        self.configTree.topLevelItem(18).child(3).setText(0, _translate("MainWindow", "swing", None))
        self.configTree.topLevelItem(18).child(3).setText(1, _translate("MainWindow", "4.0", None))
        self.configTree.topLevelItem(18).child(4).setText(0, _translate("MainWindow", "angular", None))
        self.configTree.topLevelItem(18).child(4).setText(1, _translate("MainWindow", "0.0005", None))
        self.configTree.topLevelItem(19).setText(0, _translate("MainWindow", "controller.res.cfg.max_feet_up", None))
        self.configTree.topLevelItem(19).setText(1, _translate("MainWindow", "0", None))
        self.configTree.topLevelItem(20).setText(0, _translate("MainWindow", "controller.res.cfg.speed_by_restriction", None))
        self.configTree.topLevelItem(20).setText(1, _translate("MainWindow", "True", None))
