...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.configTree.topLevelItem(1).child(1).setText(0, _translate("MainWindow", "lower", None))
        self.configTree.topLevelItem(1).child(1).setText(1, _translate("MainWindow", "3.0", None))
        self.configTree.topLevelItem(1).child(2).setText(0, _translate("MainWindow", "stance", None))
        ...
        self.configTree.topLevelItem(3).setText(1, _translate("MainWindow", "0.2", None))
        ...
        self.configTree.topLevelItem(6).setText(0, _translate("MainWindow", "controller.res.cfg.height_slop", None))
        self.configTree.topLevelItem(6).setText(1, _translate("MainWindow", "5.", None))
        self.configTree.topLevelItem(7).setText(0, _translate("MainWindow", "controller.res.cfg.foot_center", None))
        self.configTree.topLevelItem(7).child(0).setText(0, _translate("MainWindow", "x", None))
        self.configTree.topLevelItem(7).child(0).setText(1, _translate("MainWindow", "55.", None))
        self.configTree.topLevelItem(7).child(1).setText(0, _translate("MainWindow", "y", None))
        self.configTree.topLevelItem(7).child(1).setText(1, _translate("MainWindow", "0.", None))
        ...
        self.configTree.topLevelItem(9).setText(0, _translate("MainWindow", "controller.res.cfg.eps", None))
        self.configTree.topLevelItem(9).setText(1, _translate("MainWindow", "0.9", None))
        self.configTree.topLevelItem(10).setText(0, _translate("MainWindow", "controller.res.cfg.lift_height", None))
        self.configTree.topLevelItem(10).setText(1, _translate("MainWindow", "8.0", None))
        ...
        self.configTree.topLevelItem(13).setText(0, _translate("MainWindow", "controller.res.cfg.loaded_weight", None))
